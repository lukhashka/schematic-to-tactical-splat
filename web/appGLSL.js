...
const fragmentShaderGS = `#version 300 es
    ...
    void main() {
        ...
        // Робимо жорсткий квадрат/коло для конструкцій
        if (dist_sq > 1.0) discard;

        // ВИПРАВЛЕНО: aOpacity генерувалась, але раніше ігнорувалась.
        // Тепер вона реально впливає на альфу, зберігаючи жорсткий контур форми.
